...
values (true, 'NEW', null, 1, now(), 'title 1', 'post <b>text</b> <strong>1</strong>', 1)
     ...
     , ( true, 'ACCEPTED', 1, 2, '2020-05-01 00:00:00', 'title 4'
       ...
       , 1000)
     , (true, 'NEW', null, 3, now(), 'title 5', 'post text 5', 1000)
     , (true, 'NEW', null, 3, now(), 'title 6', 'post text 6', 1000)
     ...
     , (false, 'DECLINED', 1, 1, now(), 'title 10', 'post text 10', 999)
     , (false, 'NEW', null, 1, now(), 'title 11', 'post text 11', -1)
     , (true, 'NEW', null, 1, now(), 'title 12', 'post text 12', 0)
